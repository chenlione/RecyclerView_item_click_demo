...
public class MyItemAnimator extends SimpleItemAnimator {
    ...
    private void animateRemoveImpl(final ViewHolder holder) {
        ...
        animation.setDuration(getRemoveDuration())//在此处修改移除的动画
            ...
            public void onAnimationEnd(View view) {
                ...
                ViewCompat.setTranslationX(view, 0);//恢复移除的动画
    ...
    public boolean animateAdd(final ViewHolder holder) {
        ...
        ViewCompat.setTranslationX(holder.itemView, -holder.itemView.getWidth());//添加的动画
    ...
    void animateMoveImpl(final ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        final ViewPropertyAnimatorCompat animation = ViewCompat.animate(view);
        animation.rotationXBy(360);//添加的移动动画
    ...
    public boolean animateChange(ViewHolder oldHolder, ViewHolder newHolder,
        ...
        if (newHolder != null) {
            ...
            ViewCompat.setTranslationX(newHolder.itemView, -newHolder.itemView.getWidth());//改变的
        }
    ...
    void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            oldViewAnim
//                    .alpha(0)
                    .translationX(view.getWidth())//新添加的
                    .setListener(new VpaListenerAdapter() {
                @Override
                public void onAnimationStart(View view) {
